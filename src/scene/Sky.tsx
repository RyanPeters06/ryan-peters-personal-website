...
void main() {
  ...
  // ~6.6u up pitched 22 degrees down at fov 42, so every ray in frame
  // points BELOW world-horizontal — the visible sky band behind the
  // island's edge spans h = -0.27 (at the far rim) .. -0.02 (top of
  ...
  vec3 col = mix(uHorizon, uMid, smoothstep(-0.28, -0.19, h));
  col = mix(col, uTop, smoothstep(-0.21, -0.03, h));
