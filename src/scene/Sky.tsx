...
void main() {
  ...
  // ~10u up pitched ~24 degrees down, so every ray in frame points
  // BELOW world-horizontal — the visible sky band behind the island's
  // edge spans roughly h = -0.28 (at the rim) .. -0.08 (top of frame).
